...
Abrir en un editor de texto los siguientes archivos: [primates.tnt](/enlace/), example.tnt(enlace), Nicotiana.nex(enlace), [primates.nex](enlace), [primates.phy](enlace).
